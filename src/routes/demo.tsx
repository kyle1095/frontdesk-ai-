 ...
 * clinics — with the ReceptIO help desk widget embedded on it.
 *
...
function Home() {
  ...
  return (
    <div className="min-h-dvh bg-white text-slate-900">
      {/* Demo notice — this is our sample business page, not ReceptIO's own site */}
      ...
      <main>
        ...
        <section id="support" className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-8 text-sm leading-6 text-slate-600">
            This whole support experience is ReceptIO — it answers from
